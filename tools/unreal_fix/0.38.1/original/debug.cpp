...
sleep:
      ...
      if (activedbg == WNDREGS && dispatch_more(ac_regs)) // ќбработка гор€чих клавиш
      {
          continue;
      }
      if (activedbg == WNDTRACE && dispatch_more(ac_trace)) // ќбработка гор€чих клавиш
      {
          continue;
      }
      if (activedbg == WNDMEM && dispatch_more(ac_mem)) // ќбработка гор€чих клавиш
      {
          continue;
      }
      if (activedbg == WNDREGS && dispatch_regs()) // ќбработка ввода текста
      {
          continue;
      }
      if (activedbg == WNDTRACE && dispatch_trace()) // ќбработка ввода текста
      {
          continue;
      }
      if (activedbg == WNDMEM && dispatch_mem()) // ќбработка ввода текста
      {
          continue;
      }
      if (needclr)
