...
.IFDEF  WHISTLES
MSG_TITLE:
        .DW     $5B1B,$3B30,$3033,$343B,$6D30,$5B1B,$4A32,$2020
        .DW     $5B1B,$3B31,$3133,$DB6D,$1BDB,$335B,$6D33,$DBDB
        .DW     $5B1B,$3233,$DB6D,$1BDB,$335B,$6D36,$DBDB,$0A0D
        .DW     $1B20,$335B,$6D31,$DBDB,$5B1B,$3333,$DB6D,$1BDB
        .DW     $335B,$6D32,$DBDB,$5B1B,$3633,$DB6D,$20DB,$1B20
        .DW     $335B,$6D37,$DFDF,$DFDF,$20DB,$20DB,$2020,$20DB
        .DW     $DB20,$DFDF,$DFDF,$0A0D,$5B1B,$3133,$DB6D,$1BDB
        .DW     $335B,$6D33,$DBDB,$5B1B,$3233,$DB6D,$1BDB,$335B
        .DW     $6D36,$DBDB,$2020,$2020,$1B20,$335B,$6D37,$DFDC
        .DW     $2020,$DF20,$DFDC,$2020,$DB20,$DCDC,$20DC,$DB20
        .DW     $2020,$DB20,$DC20,$DFDF,$DCDF,$0A0D,$5B1B,$3133
        .DW     $DB6D,$5B1B,$3333,$DB6D,$1BDB,$335B,$6D32,$DBDB
        .DW     $5B1B,$3633,$DB6D,$20DB,$2020,$1B20,$335B,$6D37
        .DW     $DFDC,$2020,$2020,$DFDC,$DF20,$20DC,$DB20,$2020
        .DW     $2020,$DF20,$20DC,$DFDC,$DB20,$2020,$DB20,$0A0D
        .DW     $5B1B,$3333,$DB6D,$1BDB,$335B,$6D32,$DBDB,$5B1B
        .DW     $3633,$DB6D,$20DB,$2020,$2020,$5B1B,$3733,$DF6D
        .DW     $DFDF,$DFDF,$DF20,$2020,$DF20,$2020,$DFDF,$DFDF
        .DW     $20DF,$2020,$20DF,$2020,$DF20,$DFDF,$0A0D,$0A0D
        .DW     $585A,$452D,$6F76,$756C,$6974,$6E6F,$6220,$6F6F
        .DW     $6C74,$616F,$6564,$2072,$3076,$302E,$0D33,$0D0A
        .DW     $540A,$6568,$6620,$7269,$776D,$7261,$2065,$6572
        .DW     $6563,$7669,$6E69,$2E67,$2E2E,$5B1B,$3B30,$3033
        .DW     $006D
MSG_WRONGDATA:
